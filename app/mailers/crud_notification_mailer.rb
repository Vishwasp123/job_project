class CrudNotificationMailer < ApplicationMailer
  ...
  def update_notification(object)
    ...
    mail to: 'admin@example.com', subject:"An  entry for #{object.class} has been update"
  ...
  def delete_notification(object)
    ...
    mail to: 'admin@example.com', subject:"An  entry for #{object.class} has been deleteted"
